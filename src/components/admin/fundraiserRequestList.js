...
export default function FundraiserRequestList() {
    ...
    const getReqOrgList=async()=>{
        try{
            const data=await axios.get(`https://niber-backend.vercel.app/admin/reqfunds`);
    ...
    const onDelete = (id)=>{
        swal({
            ...
            if (willDelete) {
              axios
                .delete(`https://niber-backend.vercel.app/fund/delete/${id}`)
                .then(() => {
                  if (willDelete) {
    ...
    const onAccept = (id)=>{
        swal({
            ...
            if (willDelete) {
              axios
                .put(`https://niber-backend.vercel.app/admin/upfundstatus/${id}`)
                .then(() => {
                  if (willDelete) {

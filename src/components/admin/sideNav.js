          ...
          <ul className="navbar-nav">
            <li className="nav-item">
              <a
                ...
                href="https://www.niber.org/admin/dashboard"
              >
            ...
            <li className="nav-item">
              <a
                ...
                href="https://www.niber.org/admin/regorglist"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              <a
                className="nav-link text-white "
                href="https://www.niber.org/admin/regfund"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i className="material-icons opacity-10">table_view</i>
                </div>
            ...
            <li className="nav-item">
              <a className="nav-link text-white " href="/donator/createjob">
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i className="material-icons opacity-10">table_view</i>
                </div>
                <span className="nav-link-text ms-1">Vacancy</span>
              </a>
            </li>
            ...
            <li className="nav-item">
              <a
                className="nav-link text-white "
                href="https://www.niber.org/admin/accepteddon"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">

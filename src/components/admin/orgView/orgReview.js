...
export default function AdminReviewOrg() {
  ...
  useEffect(()=>{
    const fetchOrg=async()=>{
        console.log(id)
        await axios
        .get(`https://niber-backend.vercel.app/admin/vieworg/${id}`)
        .then((res)=>{
            console.log(res)
...
swal({
    ...
    if (willDelete) {
      axios
        .put(`https://niber-backend.vercel.app/admin/editorg/${id}`, Organization)
        .then(() => {
          if (willDelete) {
  ...
  const onAccept = (id)=>{
    ...
    swal({
        ...
        if (willDelete) {
          axios
            .put(`https://niber-backend.vercel.app/admin/uporgstatus/${id}`)
            .then(() => {
              if (willDelete) {
...
const onDelete = (id)=>{
    swal({
        ...
        if (willDelete) {
          axios
            .delete(`https://niber-backend.vercel.app/admin/deletereqorg/${id}`)
            .then(() => {
              if (willDelete) {
